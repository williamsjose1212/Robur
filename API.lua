...
---@field GetGameMode fun():string @"CLASSIC", "ARAM", "URF", "ONEFORALL", "NEXUSBLITZ"
...
---@field OnExtremePriority string     @[[Improved OnTick]] void OnExtremePriority() --Evade, Autosmite, etc
---@field OnHighPriority string        @[[Improved OnTick]] void OnHighPriority() --important spells etc
---@field OnNormalPriority string      @[[Improved OnTick]] void OnNormalPriority() --Orbwalker, Normal Spells
---@field OnLowPriority string         @[[Improved OnTick]] void OnLowPriority() -Pseudo-Useless Spells
...
---@field Prediction fun(self:DashInstance, FromPos:Vector, Speed: number, Delay: number, Radius: number, UseHitbox:boolean, IsTrap:boolean)
local DashInstance
...
---@field GetValidTargets fun(self: TargetSelector, maxRange: number, enemies:AIHeroClient[]|nil, checkMissileBlocks: boolean|nil)
---@field SelectTargetForMode fun(self: TargetSelector, enemies: AIHeroClient[], mode: string):AIHeroClient
---@field GetTargetFromList fun(self: TargetSelector, possibleTargets: AIHeroClient[], checkMissileBlocks: boolean|nil):AIHeroClient
---@field GetTarget fun(self: TargetSelector, maxRange:number|nil, checkMissileBlocks: boolean|nil):AIHeroClient
---@field SortTargetsForMode fun(self: TargetSelector, enemies: AIHeroClient[], mode: string):AIHeroClient[]
---@field GetTargetsFromList fun(self: TargetSelector, possibleTargets: AIHeroClient[], checkMissileBlocks: boolean|nil):AIHeroClient[]
---@field GetTargets fun(self: TargetSelector, maxRange:number|nil, checkMissileBlocks: boolean|nil):AIHeroClient[]
...
---@field RegisterMenu fun(id: string, displayText: string, func: function):nil
